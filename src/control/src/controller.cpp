    ...
    public:
        ...
        Controller() : Node("controller")
        {
            ...
            this -> joint_state_subscriber_ = this->create_subscription<sensor_msgs::msg::JointState>(
                "joint_state",
                10,
                std::bind(&Controller::joint_state_callback, this, std::placeholders::_1),
                options);
            ...
            this->update_desired_state_timer_ = this->create_wall_timer(10ms, std::bind(&Controller::update_desired_state, this));
